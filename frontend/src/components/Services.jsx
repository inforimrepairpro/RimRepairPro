  ...
  <section id="services" className="bg-[#0a0a0b] py-20 md:py-28 relative">
    <div className="max-w-7xl mx-auto px-5 md:px-8">
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-14">
        <div>
          <span className="inline-block text-[11px] uppercase tracking-[0.32em] text-[#E5A848] mb-5">Services</span>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        {SERVICES.map((s, i) => (
          <div key={i} className={`group relative rounded-[16px] p-8 border transition-all duration-300 ${s.popular ? 'bg-gradient-to-b from-[#1a1408] to-[#0f0f0f] border-[#E5A848]/40 shadow-[0_20px_50px_-20px_rgba(228,168,72,0.25)]' : 'bg-[#0f0f0f] border-[#1e1d1b] hover:border-[#E5A848]/30'}`}>
            {s.popular && (
            ...
            <div className="text-[12px] tracking-[0.3em] text-[#E5A848] font-semibold">{s.n}</div>
            ...
            <div className="mt-7 inline-flex items-center gap-1.5 text-[11px] uppercase tracking-[0.24em] text-[#E5A848] group-hover:gap-2.5 transition-all">
