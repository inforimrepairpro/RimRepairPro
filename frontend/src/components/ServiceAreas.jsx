  ...
  <section className="bg-[#0a0a0b] py-20 md:py-24 border-t border-[#1e1d1b]">
    <div className="max-w-7xl mx-auto px-5 md:px-8 grid lg:grid-cols-12 gap-10 items-start">
      <div className="lg:col-span-5">
        <span className="inline-block text-[11px] uppercase tracking-[0.32em] text-[#E5A848] mb-5">Service Areas</span>
      ...
      <div className="lg:col-span-7">
        <div className="flex flex-wrap gap-2">
          {SERVICE_AREAS.map((a, i) => (
            <span key={i} className="inline-flex items-center rounded-full border border-[#1e1d1b] bg-[#0f0f0f] px-4 py-2 text-[13px] text-[#F5F3EE] hover:border-[#E5A848] hover:text-[#E5A848] transition-colors cursor-default">
              {a}
            </span>
          ))}
        </div>
