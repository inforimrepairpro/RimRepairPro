  ...
  <section className="bg-[#0a0a0b] py-20 md:py-28 border-t border-[#1e1d1b]">
    <div className="max-w-7xl mx-auto px-5 md:px-8">
      <div className="max-w-2xl mb-14">
        <span className="inline-block text-[11px] uppercase tracking-[0.32em] text-[#C5C8CC] mb-5">How It Works</span>
        ...
        {PROCESS.map((p, i) => (
          <div key={i} className="relative group">
            <div className="flex items-center gap-4 mb-5">
              <div className="font-display text-[56px] leading-none text-[#C5C8CC]/20 font-bold group-hover:text-[#C5C8CC]/50 transition-colors">{p.n}</div>
