...
const CTA = () => (
  <section
    id="contact"
    className="bg-[#0a0a0b] py-24 md:py-32 relative border-t border-[#1e1d1b]"
  >
    ...
    <div className="relative max-w-5xl mx-auto px-5 md:px-8 text-center">
      <span className="inline-block text-[11px] uppercase tracking-[0.32em] text-[#C5C8CC] mb-6">
        Get Started
      </span>
      ...
      <div className="mt-10">
        <a
          ...
          className="gold-btn inline-flex items-center gap-3 rounded-[14px] px-10 py-5 text-[18px] md:text-[22px] font-bold tracking-tight transition-all"
        >
      ...
      <div className="mt-12 flex flex-wrap items-center justify-center gap-8 md:gap-12">
        {[
          { I: BadgeCheck, t: 'Free Estimates' },
          { I: ShieldCheck, t: 'Lifetime Warranty' },
          { I: Zap, t: 'Same-Day Service' },
        ].map((x, i) => (
          <div
            key={i}
            className="flex items-center gap-2 text-[12px] uppercase tracking-[0.24em] text-[#C5C3BE]"
          >
            <x.I className="w-4 h-4 text-[#C5C8CC]" />
            {x.t}
          </div>
        ))}
      </div>
