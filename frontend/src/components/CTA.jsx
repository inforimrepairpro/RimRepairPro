...
const CTA = () => (
  <section id="contact" className="bg-[#0a0a0b] py-24 md:py-32 relative border-t border-[#1e1d1b]">
    <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(228,168,72,0.12),transparent_55%)] pointer-events-none" />
    <div className="relative max-w-5xl mx-auto px-5 md:px-8 text-center">
      <span className="inline-block text-[11px] uppercase tracking-[0.32em] text-[#E5A848] mb-6">Get Started</span>
      ...
      <div className="mt-12 flex flex-wrap items-center justify-center gap-8 md:gap-12">
        {[{ I: BadgeCheck, t: 'Free Estimates' }, { I: ShieldCheck, t: 'Lifetime Warranty' }, { I: Zap, t: 'Same-Day Service' }].map((x, i) => (
          <div key={i} className="flex items-center gap-2 text-[12px] uppercase tracking-[0.24em] text-[#C5C3BE]">
            <x.I className="w-4 h-4 text-[#E5A848]" /> {x.t}
          </div>
        ))}
      </div>
    </div>
