...
// Production assets are served from frontend/public.
export const BRAND = {
  name: 'Rim Repair Pro',
...
export const HERO_STATS_INLINE = [
  ...
  { icon: 'Zap', label: 'Same Day', sub: 'When Available' },
  { icon: 'Award', label: 'Greater LA', sub: 'Service Area' },
];

export const STATS = [
  { value: 7, suffix: ' Days', label: 'Mobile Service' },
  { value: 3, suffix: '+', label: 'Wheels = Special Savings' },
  { value: 5, suffix: '', label: 'Core Repair Options' },
  { value: 1, suffix: ' Call', label: 'To Get Started' },
];

export const FEATURES = [
  { icon: 'Zap', title: 'Same-Day Availability', desc: 'Ask about same-day mobile appointments when you send your photos.' },
  { icon: 'Truck', title: 'Mobile Rim Repair', desc: 'We bring the service to your home, office, or convenient location.' },
  { icon: 'ShieldCheck', title: 'Careful Refinishing', desc: 'Focused cosmetic wheel repair with attention to finish and detail.' },
...
export const SERVICES = [
  ...
  { n: '03', popular: true, title: 'Lease Return Wheel Repair', desc: 'Avoid expensive dealership charges. Restore your wheels before returning your leased or rental vehicle with our professional mobile service.' },
